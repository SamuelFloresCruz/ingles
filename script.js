...
const spanishText = {
  ...
  "Reading": "Lectura",
  "Case studies and analysis about artificial intelligence in real technical situations.": "Casos de estudio y análisis sobre inteligencia artificial en situaciones técnicas reales.",
  "Improving Customer Support with Artificial Intelligence": "Mejorando la atención al cliente con inteligencia artificial",
  "Scene": "Escena",
  "A chatbot is helping a customer on a computer or phone.": "Un chatbot está ayudando a un cliente en una computadora o teléfono.",
  "Two Keywords": "Dos palabras clave",
  "Article keywords": "Palabras clave del artículo",
  "ChatBot": "ChatBot",
  "Customer Support": "Atención al cliente",
  "Prediction Question": "Pregunta de predicción",
  "What problem do you think this company has?": "¿Qué problema crees que tiene esta empresa?",
  "The company has slow customer support and too many customer requests.": "La empresa tiene un servicio de atención al cliente lento y demasiadas solicitudes de clientes.",
  "Problem": "Problema",
  "Customers wait too long for support.": "Los clientes esperan demasiado para recibir atención.",
  "Device:": "Dispositivo:",
  "Computer or smartphone": "Computadora o teléfono inteligente",
  "Recommendation:": "Recomendación:",
  "Use an AI chatbot to answer customers 24/7.": "Usar un chatbot con IA para atender a los clientes las 24 horas.",
  "The company receives too many simple questions.": "La empresa recibe demasiadas preguntas sencillas.",
  "Chatbot system": "Sistema de chatbot",
  "Automate frequently asked questions with AI.": "Automatizar las preguntas frecuentes con IA.",
  "Human agents are overloaded with requests.": "Los agentes humanos están sobrecargados de solicitudes.",
  "Computer": "Computadora",
  "Transfer complex cases to human agents and let the chatbot handle simple requests.": "Transferir los casos complejos a agentes humanos y dejar que el chatbot atienda las solicitudes simples.",
  "Customer service is not available all the time.": "El servicio al cliente no está disponible todo el tiempo.",
  "Mobile phone or computer": "Teléfono móvil o computadora",
  "Provide 24/7 customer support using artificial intelligence.": "Ofrecer atención al cliente 24/7 utilizando inteligencia artificial.",
  "Artificial Intelligence (AI)": "Inteligencia Artificial (IA)",
  "When AI Gives the Wrong Answer": "Cuando la IA da la respuesta equivocada",
  "Maria is a systems engineer at an online store. Last week, her company's AI chatbot began giving customers strange, outdated answers. When a customer asked about the return policy, the software suggested rules that ended two years ago. Maria's manager contacted technical support immediately.": "María es ingeniera de sistemas en una tienda en línea. La semana pasada, el chatbot de IA de su empresa comenzó a dar a los clientes respuestas extrañas y desactualizadas. Cuando un cliente preguntó sobre la política de devoluciones, el software sugirió reglas que terminaron hace dos años. El gerente de María contactó inmediatamente al soporte técnico.",
  "The support technician explained that the chatbot's knowledge base was not updated, so its algorithm was using old data instead of current information. \"You should connect your chatbot to live product documentation, not to a static file,\" the technician said. \"Your team must also add retrieval-augmented generation, a system that lets the software search real documents before it answers.\"": "El técnico de soporte explicó que la base de conocimiento del chatbot no estaba actualizada, por lo que su algoritmo estaba usando datos antiguos en lugar de información actual. \"Deben conectar su chatbot a documentación de productos en vivo, no a un archivo estático\", dijo el técnico. \"Su equipo también debe agregar generación aumentada por recuperación, un sistema que permite al software buscar documentos reales antes de responder\".",
  "The technician gave more recommendations. Customers should always be able to reach a human agent when the AI cannot solve their problem. Maria's team might also want to check the chatbot's temperature setting, because a high value can make its answers less predictable. In addition, developers could add sentiment analysis, a feature that detects an angry or confused tone and sends the conversation to a person faster.": "El técnico dio más recomendaciones. Los clientes siempre deben poder comunicarse con un agente humano cuando la IA no pueda resolver su problema. El equipo de María también podría revisar la configuración de temperatura del chatbot, porque un valor alto puede hacer que sus respuestas sean menos predecibles. Además, los desarrolladores podrían agregar análisis de sentimiento, una función que detecta un tono enojado o confundido y envía la conversación a una persona más rápido.",
  "Maria thanked the technician and shared the recommendations with her team. Within a week, the company's chatbot could give correct, current answers again, and customer complaints dropped. This case shows that even smart software needs regular maintenance, human supervision, and the right hardware and software tools working together.": "María agradeció al técnico y compartió las recomendaciones con su equipo. En una semana, el chatbot de la empresa pudo volver a dar respuestas correctas y actuales, y las quejas de los clientes disminuyeron. Este caso muestra que incluso el software inteligente necesita mantenimiento regular, supervisión humana y las herramientas adecuadas de hardware y software trabajando juntas.",
  "Analysis": "Análisis",
  "Sentences": "Oraciones",
  "This case study illustrates the critical importance of maintaining and updating AI systems to ensure reliability. The chatbot's failure stemmed from outdated data, highlighting that static knowledge bases quickly become obsolete. The solution involved connecting the AI to live documentation, integrating retrieval-augmented generation, and adding safeguards like sentiment analysis and human fallback. Together, these measures emphasize that effective AI deployment is not just about algorithms but about continuous monitoring, human oversight, and adaptive tools that keep systems aligned with real-world needs.": "Este caso de estudio ilustra la importancia crítica de mantener y actualizar los sistemas de IA para garantizar su confiabilidad. La falla del chatbot se originó en datos desactualizados, lo que demuestra que las bases de conocimiento estáticas se vuelven obsoletas rápidamente. La solución incluyó conectar la IA a documentación en vivo, integrar generación aumentada por recuperación y agregar medidas de seguridad como análisis de sentimiento y apoyo humano. En conjunto, estas medidas enfatizan que una implementación efectiva de IA no se trata solo de algoritmos, sino también de monitoreo continuo, supervisión humana y herramientas adaptativas que mantienen los sistemas alineados con las necesidades del mundo real.",
